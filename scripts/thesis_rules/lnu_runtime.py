...
LNU_RULE_DEFINITIONS = (
    ...
    ("LNU_TOC01", "目录标题与条目样式（辽大）", "important"),
    ("LNU_TOC02", "目录条目行距多倍1.15倍，段后5磅（辽大）", "important"),
    ("LNU_TOC03", "目录区段存在并可核对页码（辽大）", "important"),
    ("LNU_TB02", "表格内容宋体五号（辽大）", "minor"),
    ("LNU_TB04", "表块留白与表题贴表（辽大）", "minor"),
    ("LNU_ABS01", "摘要标题格式（辽大）", "important"),
    ("LNU_ABS02", "Abstract标题格式（辽大）", "minor"),
    ("LNU_ABS03", "英文摘要正文格式（辽大）", "important"),
    ...
    ("LNU_TB03", "表格内容单倍行距（辽大）", "important"),
